                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="product-pic-zoom">
                                <img class="product-big-img" :src="default_pict" alt="" />
                            </div>
                            <div class="product-thumbs">
                                <carousel :dots="false" :nav="false" class="product-thumbs-track ps-slider">
                                    <div class="pt" @click="changeImage(thumbs[0])" 
                                    :class="thumbs[0] == default_pict ? 'active' : '' ">
                                        <img src="img/sepatu1.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImage(thumbs[1])"
                                    :class="thumbs[1] == default_pict ? 'active' : '' ">
                                        <img src="img/sepatu2.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImage(thumbs[2])"
                                    :class="thumbs[2] == default_pict ? 'active' : '' ">
                                        <img src="img/sepatu3.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImage(thumbs[3])"
                                    :class="thumbs[3] == default_pict ? 'active' : '' ">
                                        <img src="img/sepatu4.jpg" alt="" />
                                    </div>
                                </carousel>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="product-details text-left">
                                ...
                                <div class="quantity">
                                    <router-link to="/card"><a href="shopping-cart.html" class="primary-btn pd-cart">Add To Cart</a></router-link>
                                </div>
                            </div>
                        </div>
                    </div>
...
import HeaderArif from '@/components/HeaderArif.vue';
  import FotherBawah from '@/components/FotherBawah.vue';
